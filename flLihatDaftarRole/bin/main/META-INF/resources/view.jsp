			...
			<table class="table">
				...
				<tbody>
					<tr>
						...
						<td>Aktif</td>
						<td><a href="javascript:void(0)" onclick="document.getElementById('id01').style.display='block'" data-toggle="tooltip" data-placement="top" title="Lihat Back Office"><i class="fa fa-eye"></i></a></td>
						<td><a href="javascript:void(0)" onclick="document.getElementById('id02').style.display='block'" data-toggle="tooltip" data-placement="top" title="Ubah Back Office"><i class="fa fa-pencil-square-o"></i></a></td>
						<td><a href="javascript:void(0)" onclick="document.getElementById('id03').style.display='block'" data-toggle="tooltip" data-placement="top" title="Hapus Pemetaan Back Office"><i class="fa fa-trash-o"></i></a></td>
					</tr>
				</tbody>
			</table>
	...
	<div class="w3-modal-content w3-animate-zoom" style="max-width: 500px;">
		...
		<div class="w3-container pb-3">
			<div class="text-center">
				...
				menghapus pemetaan Back Office ke Role ?</p>
			</div>
			<div class="text-right">
